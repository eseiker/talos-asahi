...
```text
talos-asahi-v1.13.10-asahi.2-esp.zip
talos-asahi-v1.13.10-asahi.2-mainline-esp.zip
talos-asahi-v1.13.10-asahi.2-mainline-4k-esp.zip
talos-asahi-v1.13.10-asahi.2-v1.15-esp.zip
talos-asahi-v1.13.10-asahi.2-longhorn-esp.zip
talos-asahi-v1.13.10-asahi.2-mainline-longhorn-esp.zip
talos-asahi-v1.13.10-asahi.2-mainline-4k-longhorn-esp.zip
talos-asahi-v1.13.10-asahi.2-v1.15-longhorn-esp.zip
```
...
EFI/Linux/Talos-v1.13.10.efi
loader/loader.conf
```

The mainline bundle names its final UKI
`EFI/Linux/Talos-v1.13.10-mainline.efi`; the custom 4 KiB and compatibility
...
```sh
BUNDLE="$HOME/Downloads/talos-asahi-v1.13.10-asahi.2-esp.zip"
...
machine:
  install:
    disk: /dev/nvme0n1
    image: ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2
    wipe: false
```
...
`:v1.13.10-asahi.2-mainline` with the mainline 16K ZIP,
`:v1.13.10-asahi.2-mainline-4k` with the custom mainline 4K ZIP, and
`:v1.13.10-asahi.2-v1.15` with the compatibility ZIP. Mixing them causes
...
```text
ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2
```
...
```text
ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2-longhorn
ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2-mainline-longhorn
ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2-mainline-4k-longhorn
ghcr.io/OWNER/talos-asahi/installer:v1.13.10-asahi.2-v1.15-longhorn
```
...
non-default bundles use `Talos-v1.13.10-mainline.efi`,
`Talos-v1.13.10-mainline-4k.efi`, and
`Talos-v1.13.10-v1.15.efi` so all kernel flavors remain
distinguishable.
